...
targetSections.forEach(sectionId => {
    ...
    if (match) {
        ...
        let icons = '';
        const iconsMatch = itemHtml.match(/<div class="ingredient-icons">[\s\S]*?<\/div>\s*<\/div>/); // wait, it might end in just </div>
        // Let's rely on extracting ingredient-icons specifically
