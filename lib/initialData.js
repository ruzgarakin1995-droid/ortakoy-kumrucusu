...
export const initialExpenses = [
  { id: 'exp_1', name: 'Elektrik Faturası', amount: 1500, date: new Date().toISOString() },
  { id: 'exp_2', name: 'Su Faturası', amount: 400, date: new Date().toISOString() },
  { id: 'exp_3', name: 'İnternet', amount: 350, date: new Date().toISOString() }
];
