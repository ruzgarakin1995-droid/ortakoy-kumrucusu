...
import { initialBanners, initialFeatured, initialCategories, initialCoupons, initialOrders, initialSettings } from './initialData';
...
function getKVUrl() { return process.env.KV_REST_API_URL || process.env.UPSTASH_REDIS_REST_URL || process.env.STORAGE_REST_API_URL; }
function getKVToken() { return process.env.KV_REST_API_TOKEN || process.env.UPSTASH_REDIS_REST_TOKEN || process.env.STORAGE_REST_API_TOKEN; }
...
export async function getSettings() {
  return (await getData('settings')) || initialSettings;
}
